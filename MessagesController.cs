                ...
                else
                {
                    ...
                    else 
                    {
                        ...
                        if(Globals.maxMoodIndex == 0 || Globals.maxMoodIndex == 1 || Globals.maxMoodIndex == 2 || Globals.maxMoodIndex == 3 || Globals.maxMoodIndex == 5 || Globals.maxMoodIndex == 6){
                            ...
                            {
                                //HARRASSMENT REPLY
                                reply = activity.CreateReply($"Is everything fine? Do you feel like you're being harassed online? Don't feel afraid to reach out! Here are some resources: http://www.igda.org/default.asp?page=harassmentresources#what-to-do Also sign the pledge against online harassement! http://www.hackharassment.com/pledge/" + Globals.interactionCount);
                            }
                            else
                            {
